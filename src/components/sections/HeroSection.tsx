...
export default function HeroSection() {
  ...
  const marqueeInView = useInView(marqueeRef, { margin: "0px 0px 100px 0px" });
  return (
    <section data-scroll-id="hero" className="h-screen md:h-screen relative overflow-hidden flex flex-col z-10 shrink-0">
      <div className="max-w-[1440px] mx-auto px-8 pt-24 pb-6 relative z-10 flex flex-col h-full w-full">
        <main className="flex-grow flex flex-col justify-center relative mt-0 mb-8">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-2 relative w-fit pl-[120px] pt-4 pb-2">
              ...
              <FadeIn delay={0.1} direction="up" className="relative z-10 w-full max-w-[280px] sm:max-w-[380px] md:max-w-[480px] lg:max-w-[580px]">
          ...
          <FadeIn delay={0.15} direction="right" className="absolute right-4 md:right-32 top-1/2 -translate-y-1/2">
            <p className="text-sm font-bold uppercase tracking-widest opacity-80">{t("hero.showreelCaption")}</p>
          </FadeIn>
        </main>

        <FadeIn delay={0.2} direction="up" className="mt-auto flex flex-col items-center pb-4">
          ...
          <div className="flex items-center justify-center gap-8 w-full">
            ...
            <div className="w-full max-w-[280px] sm:max-w-[420px] md:max-w-[576px] overflow-hidden relative">
              ...
              <div ref={marqueeRef} className="flex gap-3 w-max animate-marquee" style={{ animation: "marquee 15s linear infinite", animationPlayState: marqueeInView ? "running" : "paused" }}>
        ...
        <FadeIn delay={0.3} direction="none" className="absolute left-8 bottom-24 z-10">
          <ScrollIndicator />
        </FadeIn>
      </div>
    </section>
